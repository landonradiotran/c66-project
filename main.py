...
modelConfiguration = 'TNK-M9-PRO-C66-PCP-BP-main/cfg/yolov3.cfg'
modelWeights = 'TNK-M9-PRO-C66-PCP-BP-main/yolov3.weights'

# Path to labels file
labelsPath = 'TNK-M9-PRO-C66-PCP-BP-main\coco.names'
...
# Load image
image = cv2.imread('TNK-M9-PRO-C66-PCP-BP-main/static/img1.jpg')
